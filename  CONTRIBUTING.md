...
- Go to the [Issues tab](https://github.com/BU-SENG/foss-project-mustard-brown/issues)
- Click **"New Issue"**
- Choose "Bug Report" or "Feature Request"
- Write a clear title and description (screenshots help a lot!)
- Submit — that’s it! We’ll take it from there.
